...
val find_by_model : Database.ctx -> Model.t -> t list Lwt.t
val find_by_group : Database.ctx -> Group.Id.t -> t list Lwt.t
val find_ungrouped_by_model : Database.ctx -> Model.t -> t list Lwt.t
val find : Database.ctx -> Id.t -> (t, Pool_message.Error.t) Lwt_result.t
val find_for_duplicate_check : Database.ctx -> t list Lwt.t
...
val find_to_merge_contact : Database.ctx -> Contact.Id.t -> Public.t list Lwt.t
...
val all_required_answered : Database.ctx -> Contact.Id.t -> bool Lwt.t
val all_answered : Database.ctx -> Contact.Id.t -> bool Lwt.t
val all_prompted_on_registration : Database.ctx -> Public.t list Lwt.t
...
val find_options_by_field : Database.ctx -> Id.t -> SelectOption.t list Lwt.t
...
val find_groups_by_model : Database.ctx -> Model.t -> Group.t list Lwt.t
val find_names : Database.ctx -> Id.t list -> (Pool_common.Id.t * Name.t) list Lwt.t
