...
val increment_smtp_bounce : _ Database.ctx -> EmailAddress.t -> unit Lwt.t
...
val reset_smtp_bounce : _ Database.ctx -> EmailAddress.t -> unit Lwt.t
...
module Web : sig
  ...
  val user_from_token
    :  ?key:string
    -> 'maybe_txn Database.ctx
    -> ('maybe_txn Database.ctx -> string -> k:string -> Id.t option Lwt.t)
    -> Rock.Request.t
    -> t option Lwt.t
